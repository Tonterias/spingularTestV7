...
describe('Appuser e2e test', () => {
  ...
  it('should create an instance of Appuser', () => {
    ...
    cy.get(`[data-cy="creationDate"]`).type('2021-05-07T05:22').invoke('val').should('equal', '2021-05-07T05:22');
    ...
    cy.get(`[data-cy="birthdate"]`).type('2021-05-07T11:02').invoke('val').should('equal', '2021-05-07T11:02');

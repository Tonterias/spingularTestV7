...
describe('Notification e2e test', () => {
  ...
  it('should create an instance of Notification', () => {
    ...
    cy.get(`[data-cy="creationDate"]`).type('2021-05-07T08:35').invoke('val').should('equal', '2021-05-07T08:35');


    cy.get(`[data-cy="notificationDate"]`).type('2021-05-07T12:41').invoke('val').should('equal', '2021-05-07T12:41');

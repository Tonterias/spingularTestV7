...
describe('Post e2e test', () => {
  ...
  it('should create an instance of Post', () => {
    ...
    cy.get(`[data-cy="creationDate"]`).type('2021-05-06T13:59').invoke('val').should('equal', '2021-05-06T13:59');


    cy.get(`[data-cy="publicationDate"]`).type('2021-05-07T06:08').invoke('val').should('equal', '2021-05-07T06:08');
